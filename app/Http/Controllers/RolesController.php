...
class RolesController extends Controller
{
    ...
    public function index()
    {
        ...
        // ]);
        return view('roles.list', ['roles'=>Roles::all()]);
    }
    ...
    {
        $role = $this->rolesModel::query()->with('permissions:id,name,display_name')->findOrFail($id);
    ...
    {
        $role = $this->rolesModel::query()->with('permissions:id')->findOrFail($id);
        ...
        $permissions = $this->permissionModel::all(['id', 'name', 'display_name'])
                                             ->map(function ($permission) use ($role) {
                                                 $permission->assigned = $role->permissions->pluck('id')
